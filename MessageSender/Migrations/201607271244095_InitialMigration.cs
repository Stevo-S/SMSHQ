                ...
                c => new
                    {
                        ...
                        Destination = c.String(maxLength: 16),
                        DeliveryStatus = c.String(maxLength: 64),
                        ServiceId = c.String(maxLength: 32),
                        Correlator = c.String(maxLength: 64),
                        TraceUniqueId = c.String(maxLength: 128),
